...
\begin{homeworkProblem}
    ...
    \begin{enumerate}[a)]
            ...
            \item A is positive definite if every principal submatrix of A has a positive determinant.
            From a), the largest submatrix has a positive determinant when \(\alpha > (2/3)\beta\).
            ...
            And the determinant is \(2\alpha - \beta\), so this is positive when \(\alpha > (1/2)\beta\).
            The final submatrix is simply
            \[
                \begin{split}
                    A_c &=
                    \begin{bmatrix}
            ...
            Which has positive determinant when \(\alpha > 0\).

            Therefore, A is positive definite when \(\alpha > 0\) and \(\alpha > (2/3)\beta\).
        \end{enumerate}
\end{homeworkProblem}
...
\begin{homeworkProblem}
    ...
    \(||\vec{x}||_\infty\) is determined by
    \[
        \begin{split}
    ...
    \(\cos(k)\) and \(\sin(k)\) will oscillate between -1 and 1, but \(e^k\) will increase as \(k\) increases.
    Therefore, \(||\vec{x}||_\infty = e^k\).
    \\

    \(||\vec{x}||_2\), the Euclidean norm, is
    \[
        \begin{split}
            ||\vec{x}||_2 &= \sqrt{\cos^2(k) + \sin^2(k) + e^{2k}}
        \end{split}
    \]
    \\
